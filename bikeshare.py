...
def get_filters():
    ...
    while 1:
        ...
        if city not in CITY_DATA:
            print('something wrong !, Kindly enter a valid city\n')
            continue
        city = CITY_DATA[city]
        break
    ...
    while 1:
        choice = input('Do you want to filter the data by month and/or week? Yes/No\n ').lower()
        if choice=='yes':
            choice=True
        elif choice=='no':
            choice=False
        else:
            print('something wrong !, Kindly enter a valid choice\n')
            continue
        break

    while 1:
        if choice:
            filter=input('You can filter by month , day or both\n ').lower()
            if filter=='month':
                month = input('please choose wchich month you want data from:\n january, february, march, april, may, june\n').lower()
                ...
                day = input("please choose wchich day you want data from:\n monday, tuesday, wednesday, thursday, friday, saturday, sunday\n").lower()
                ...
                print('something wrong !. Could you try again?')
                continue
            break
        else:
            day='all'
